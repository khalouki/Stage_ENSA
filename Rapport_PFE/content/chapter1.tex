\chapter{Présentation de l’organisme d’accueil et cadre général du projet}
...
L’établissement propose plusieurs formations orientées vers les sciences appliquées et les technologies modernes. Dans le cadre de ce rapport, l’intérêt porte principalement sur la formation \textbf{Data Science et Sécurité des Systèmes d’Information}, qui couvre des domaines tels que :

\begin{itemize}
    \item le développement logiciel et web ;
    \item la conception des systèmes d’information ;
    \item la sécurité informatique ;
    \item l’analyse de données et l’intelligence artificielle ;
    \item les architectures distribuées et les systèmes connectés.
\end{itemize}

Ces compétences sont directement mobilisées dans le projet Virtual FabLab, qui combine développement web, simulation 3D, communication IoT et exploitation de données.
...
Dans ce contexte, la création d’un FabLab virtuel représente une réponse pertinente. Elle permet de préparer les utilisateurs avant l’utilisation réelle des machines, de simuler des trajectoires de fabrication et d’introduire une couche de supervision intelligente fondée sur les données.
...
\begin{itemize}
    ...
    \item analyser les données collectées afin de détecter les anomalies et d’estimer l’état de santé des machines ;
...
\begin{itemize}
    ...
    \item un module Data Science pour la détection d’anomalies, le score de santé et la maintenance prédictive.
\end{itemize}
