...
\begin{itemize}
    ...
    \item un module Data Science pour la détection d’anomalies, le score de santé, l’estimation indicative du risque de panne et les recommandations de maintenance.
\end{itemize}
